  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12">
      ...
      <div className="col-span-7 place-self-center text-center sm:text-left">
        ...
        <div>
          <Link href="#contact">
            <button className="px-10 py-4 w-full rounded-full mr-4 mb-2 hover:bg-slate-300 text-white sm:w-fit bg-linear-to-br from-blue-500 via-purple-500 to-pink-500">
              Hire Me
            </button>
          </Link>
